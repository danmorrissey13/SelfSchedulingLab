Public Class CalM1
    ...
    Public Shared Function GetString_AvailHoursByDate(ByVal intPtID As Integer, ByVal strDate As String) As String
        Dim oSS As New clsSelfScheduling
        Dim strHours As String = oSS.GetString_AvailHoursByDate(intPtID, CDate(strDate), 0)
        Return strHours
    End Function
    <System.Web.Services.WebMethod()>
    ...
    Private Sub LoadAvailableHours()
        ...
        Dim strHours As String = oSS.GetString_AvailHoursByDate(mintPtID, CDate(strDate), 0)
