<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CalM1.aspx.vb" Inherits="SelfSchedulingLab.CalM1" %>
...
<div style="
    ...
    <script>
        function test() {
            //var daysTillXM = daysTillXmas(2023,11,25);
            //var daysTillNY = daysTillNewYears(2023,0,1);
            //alert('DaysTillXM = ' + daysTillXM + ', daDays Till NY = ' + daysTillNY);
            var chk = new Date();
            var chkY = chk.getFullYear();
            var chkM = chk.getMonth();
            var nextMonth = chkM + 1;
            var daysLeft = daysLeftThisMonth()
            var blnDate = (chkY == 2023 && chkM + 1 == nextMonth)
            alert("daysLeft="+ daysLeft + ", nextMonth=" + nextMonth + ", blnDate=" + blnDate);
        }
        ...
        function loadTimes() {
            ...
            $.ajax({
                type: "POST",
                url: "Cal.aspx/GetString_AvailHoursByDate",
                beforeSend: function () {
                    // $(".modal").show();
                },
                complete: function () {
